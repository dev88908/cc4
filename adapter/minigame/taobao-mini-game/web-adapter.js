...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
$global.screencanvas = $global.screencanvas || new _Canvas["default"]();
var canvas = $global.screencanvas;
...
},{"./Canvas":6}],11:[function(require,module,exports){
"use strict";
...
},{"./Element":7,"./WindowProperties":19,"./util/index.js":28}],12:[function(require,module,exports){
"use strict";
...
},{"./Canvas":6}],13:[function(require,module,exports){
"use strict";
...
var MultiWebSocket = /*#__PURE__*/function () {
  function MultiWebSocket(url) {
    var _this = this;
    var protocols = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
    _classCallCheck(this, MultiWebSocket);
    ...
    socketTask.onClose(function (res) {
      _this.readyState = MultiWebSocket.CLOSED;
    ...
    socketTask.onOpen(function (res) {
      _this.readyState = MultiWebSocket.OPEN;
...
exports["default"] = MultiWebSocket;
_defineProperty(MultiWebSocket, "CONNECTING", 0);
// The connection is not yet open.
_defineProperty(MultiWebSocket, "OPEN", 1);
// The connection is open and ready to communicate.
_defineProperty(MultiWebSocket, "CLOSING", 2);
// The connection is in the process of closing.
_defineProperty(MultiWebSocket, "CLOSED", 3);
...
},{"./EventTarget.js":8}],17:[function(require,module,exports){
"use strict";
...
var WebSocket = /*#__PURE__*/function () {
  function WebSocket(url) {
    ...
    this._onClose = function (res) {
      ...
      _this._decreaseCount();
      _this._removeAllSocketListener();
  ...
  _createClass(WebSocket, [{
    ...
    value: function send(data) {
      ...
      if (typeof data !== 'string' && !(data instanceof ArrayBuffer) && !ArrayBuffer.isView(data)) {
        ...
        my.sendSocketMessage({
          ...
          isBuffer: isBuffer,
          fail: function fail(res) {
            _this2._triggerEvent('error', res);
          }
        });
      }
    }
    ...
    key: "_removeAllSocketListener",
    value: function _removeAllSocketListener() {
...
exports.screen = exports.performance = exports.ontouchstart = exports.ontouchmove = exports.ontouchend = exports.devicePixelRatio = void 0;
var _my$getWindowInfoSync = my.getWindowInfoSync(),
  pixelRatio = _my$getWindowInfoSync.pixelRatio,
  windowWidth = _my$getWindowInfoSync.windowWidth,
  windowHeight = _my$getWindowInfoSync.windowHeight;
  ...
  _createClass(XMLHttpRequest, [{
    ...
    value: function send() {
      ...
      if (this.readyState !== XMLHttpRequest.OPENED) {
        ...
        var myRequestTask = my.tb.request({
          ...
          options: {
            ...
            enableSystemParams: true
          },
          success: function success(res) {
            _this3.status = res.code;
            _this3.responseText = _this3.response = res.content;
            _responseHeader.set(_this3, _requestHeader.get(_this3));
          ...
          fail: function fail(res) {
            _triggerEvent.call(_this3, 'error', res);
            _triggerEvent.call(_this3, 'loadend');
          }
        });
...
},{"./EventTarget.js":8}],21:[function(require,module,exports){
"use strict";
...
},{"./Audio":5,"./Canvas":6,"./HTMLElement":11,"./Image":13,"./window":29}],23:[function(require,module,exports){
"use strict";
...
function inject() {
  ...
  var windowInfo = my.getWindowInfoSync();
  var _innerHeight = windowInfo.windowHeight;
  var _innerWidth = windowInfo.windowWidth;
...
},{"../../../../common/xmldom/dom-parser":1,"../unify":30,"./document":22,"./window":29}],24:[function(require,module,exports){
"use strict";
...
},{"./util/index.js":28}],27:[function(require,module,exports){
"use strict";
...
var _MultiWebSocket = _interopRequireDefault(require("./MultiWebSocket"));
...
if (typeof my !== 'undefined' && my && my.canIUse && my.canIUse('connectSocket.object.multiple')) {
  $global.WebSocket = _MultiWebSocket["default"];
} else {
  $global.WebSocket = _WebSocket["default"];
}

},{"./HTMLCanvasElement":10,"./HTMLElement":11,"./HTMLImageElement":12,"./Image":13,"./ImageBitmap":14,"./MultiWebSocket":15,"./WebGLRenderingContext":17,"./WebSocket":18,"./WindowProperties":19,"./XMLHttpRequest":20,"./cancelAnimationFrame":21,"./localStorage":24,"./location":25,"./navigator":26,"./requestAnimationFrame":27}],30:[function(require,module,exports){
"use strict";
