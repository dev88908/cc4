...
var Audio = /*#__PURE__*/function (_HTMLAudioElement) {
  ...
  function Audio(url) {
    ...
    _innerAudioContextMap.set(_assertThisInitialized(_this), innerAudioContext);
...
},{"./HTMLAudioElement":15}],6:[function(require,module,exports){
"use strict";
...
function Canvas() {
  ...
  if (!_util.isIDE) {
    ...
    canvas.__proto__.__proto__ = new _HTMLCanvasElement["default"]();
  }
  return canvas;
}

},{"./HTMLCanvasElement":16,"./utils/util":34}],8:[function(require,module,exports){
"use strict";
...
},{"./Node":23,"./utils/noop":33}],9:[function(require,module,exports){
"use strict";
...
},{"./utils/noop":33}],10:[function(require,module,exports){
"use strict";
...
function eventHandlerFactory(type) {
  return function (rawEvent) {
    ...
    _document["default"].dispatchEvent(event);
  };
}
...
},{"../Event":9,"../document":28,"../utils/util":34}],12:[function(require,module,exports){
"use strict";
...
},{"./MouseEvent":10,"./TouchEvent":11}],13:[function(require,module,exports){
"use strict";
...
},{"./HTMLMediaElement":19}],16:[function(require,module,exports){
"use strict";
...
var HTMLCanvasElement = /*#__PURE__*/function (_HTMLElement) {
  ...
  return _createClass(HTMLCanvasElement);
...
},{"./Element":8,"./WindowProperties":26,"./utils/noop":33}],18:[function(require,module,exports){
"use strict";
...
},{"./HTMLElement":17}],19:[function(require,module,exports){
"use strict";
...
var HTMLMediaElement = /*#__PURE__*/function (_HTMLElement) {
  ...
  function HTMLMediaElement(tagName) {
    ...
    return _possibleConstructorReturn(_this, _this = _super.call(this, tagName));
  }
...
},{"./HTMLMediaElement":19}],21:[function(require,module,exports){
"use strict";
...
function Image() {
  ...
  if (!_util.isIDE) {
    image.__proto__ = new _HTMLImageElement["default"]();
...
},{"./HTMLImageElement":18,"./utils/util":34}],22:[function(require,module,exports){
"use strict";
...
},{"./EventTarget":13,"./utils/noop":33}],24:[function(require,module,exports){
"use strict";
...
},{"./utils/util":34}],26:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.screen = exports.innerWidth = exports.innerHeight = exports.devicePixelRatio = void 0;
      ...
      if (this.readyState !== OPENED) {
        ...
        var task = my.request({
          ...
          success: function success(res) {
            ...
            _this2.responseText = !_this2.responseType || _this2.responseType === 'text' ? data : '';
          ...
          fail: function fail(res) {
            var _res$errorMessage = res.errorMessage,
              errorMessage = _res$errorMessage === void 0 ? "" : _res$errorMessage,
              _res$error = res.error,
              error = _res$error === void 0 ? -1 : _res$error;
            if (error === 9) {
...
},{"./EventTarget":13}],28:[function(require,module,exports){
"use strict";
...
},{"./Audio":5,"./Canvas":7,"./Event":9,"./EventIniter/index.js":12,"./HTMLElement":17,"./HTMLVideoElement":20,"./Image":21,"./WindowProperties":26}],29:[function(require,module,exports){
"use strict";
...
function inject() {
  ...
  if (_util.isIDE) {
    ...
    for (var _key2 in _window.document) {
      var _descriptor = Object.getOwnPropertyDescriptor(window.document, _key2);
      if (!_descriptor || _descriptor.configurable === true) {
        Object.defineProperty(window.document, _key2, {
...
},{"../../../../common/xmldom/dom-parser":1,"../unify":36,"./document":28,"./utils/util":34,"./window":35}],30:[function(require,module,exports){
"use strict";
...
var _ref = systemInfo || {},
  ...
  platform = _ref$platform === void 0 ? "android" : _ref$platform,
...
var userAgent = "Mozilla/5.0 (".concat(uaDesc, ") AliApp(AP/").concat(systemInfo.version, ") AppleWebKit/603.1.30 (KHTML, like Gecko) Mobile/14E8301 AlipayMiniGame NetType/WIFI Language/").concat(language);
if (window.navigator) {
...
},{"./utils/noop":33}],33:[function(require,module,exports){
"use strict";
...
var isIDE = window.navigator && /AlipayIDE/.test(window.navigator.userAgent);
exports.isIDE = isIDE;

},{"../Base64":6}],35:[function(require,module,exports){
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
var location = _location["default"];

// 暴露全局的 canvas
exports.location = location;
window.screencanvas = window.screencanvas || new _Canvas["default"]();
window.self = window;
...
},{"./Audio":5,"./Base64":6,"./Canvas":7,"./Element":8,"./EventIniter/index.js":12,"./FileReader":14,"./HTMLAudioElement":15,"./HTMLCanvasElement":16,"./HTMLElement":17,"./HTMLImageElement":18,"./HTMLMediaElement":19,"./HTMLVideoElement":20,"./Image":21,"./ImageBitmap":22,"./WebGLRenderingContext":24,"./WebSocket":25,"./WindowProperties":26,"./XMLHttpRequest":27,"./localStorage":30,"./location":31,"./navigator":32}],36:[function(require,module,exports){
"use strict";
