...
elseif(${CMAKE_SYSTEM_NAME} MATCHES "Emscripten")
    ...
    # Suppress Boost/third-party warnings: nontrivial-memcall, deprecated-builtins
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wno-nontrivial-memcall -Wno-deprecated-builtins")
elseif(OHOS)
    set(OHOS TRUE)
...
if("$ENV{COCOS_ENGINE_DEV}" EQUAL "1")
    ...
    elseif(LINUX)
        set(WERROR_FLAGS " ${WERROR_FLAGS} -Wno-nullability-completeness -Wno-deprecated-declarations -Wno-deprecated-builtins -Wno-nontrivial-memcall")
    elseif(ANDROID)
        set(WERROR_FLAGS " ${WERROR_FLAGS} -Wno-deprecated-declarations -Wno-unknown-warning-option -Wno-deprecated-builtins")
    elseif(EMSCRIPTEN)
        set(WERROR_FLAGS " ${WERROR_FLAGS} -Wno-deprecated-declarations -Wno-deprecated-builtins -Wno-nontrivial-memcall")
    elseif(OPENHARMONY)
...
elseif(EMSCRIPTEN)
    ...
    set(USE_SE_JSVM ON CACHE BOOL "" FORCE)
    set(USE_V8_DEBUGGER OFF CACHE BOOL "" FORCE)
    set(USE_V8_DEBUGGER_FORCE OFF CACHE BOOL "" FORCE)
    set(USE_WEBP OFF CACHE BOOL "" FORCE)
    add_compile_definitions(CC_USE_WEBP=0)
    include(${CMAKE_CURRENT_LIST_DIR}/../templates/cmake/wasm.cmake)
else()
